...
const AddTours = () => {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    axios
      .post(`https://journeyvibes1-server.onrender.com/tours`, { image,image1,image2,image3,image4, destination,rating,tourname,category,type,rate,inclusions,exclusions,highlights,duration,description})
      .then((res) => {
