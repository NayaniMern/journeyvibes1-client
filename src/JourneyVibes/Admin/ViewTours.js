...
const ViewTours = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://journeyvibes1-server.onrender.com/tours`)
  ...
  const deleteTours = (toursId) => {
    axios
      .delete(`https://journeyvibes1-server.onrender.com/tours/${toursId}`)
      .then(() => alert("Your Selected Tour was Deleted"))
      .catch((err) => console.log(err));
  };
  const getOneRecord = (toursId) => {
    axios
      .get(`https://journeyvibes1-server.onrender.com/tours/${toursId}`)
      .then((res) => {
  ...
  const updateEnq = (e) => {
    e.preventDefault();
    axios
      .put(`https://journeyvibes1-server.onrender.com/tours/${_id}`, {
        _id,
        image,
        image1,
