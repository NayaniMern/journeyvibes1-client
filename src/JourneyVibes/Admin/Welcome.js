...
const Welcome = () => {
  const tours = useCallApi(`https://journeyvibes1-server.onrender.com/tours`);
  const services = useCallApi(`https://journeyvibes1-server.onrender.com/services`);
  const blogs = useCallApi(`https://journeyvibes1-server.onrender.com/blogs`);
  const enquiries = useCallApi(`https://journeyvibes1-server.onrender.com/enquiries`);
   const usersignups = useCallApi(`https://journeyvibes1-server.onrender.com/usersignup`);
  useEffect(() => {
        window.scrollTo(0, 0);
      }, []);
  return (
