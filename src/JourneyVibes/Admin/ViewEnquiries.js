...
const ViewEnquiries = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://journeyvibes1-server.onrender.com/enquiries`)
  ...
  const deleteEnq = (enqId) => {
    axios
      .delete(`https://journeyvibes1-server.onrender.com/enquiries/${enqId}`)
      .then(() => alert("Your Selected Enquiry was Deleted"))
      .catch((err) => console.log(err));
  };
  const getOneRecord = (enqId) => {
    axios
      .get(`https://journeyvibes1-server.onrender.com/enquiries/${enqId}`)
      .then((res) => {
  ...
  const updateEnq = (e) => {
    e.preventDefault();
    axios
      .put(`https://journeyvibes1-server.onrender.com/enquiries/${_id}`, {
        name,
        mobile,
        email,
        message,
