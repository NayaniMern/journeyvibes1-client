...
const ViewBookings = () => {
  ...
  useEffect(() => {
    axios
      .get("https://journeyvibes1-server.onrender.com/bookings")
  ...
  const deleteBooking = (id) => {
    axios
      .delete(`https://journeyvibes1-server.onrender.com/bookings/${id}`)
      .then(() => {
  ...
  const getBooking = (id) => {
    axios
      .get(`https://journeyvibes1-server.onrender.com/bookings/${id}`)
      .then((res) => {
        const b = res.data;
  ...
  const updateBooking = (e) => {
    e.preventDefault();
    axios
      .put(`https://journeyvibes1-server.onrender.com/bookings/${_id}`, {
        fullName,
        phone,
        email,
        tourName,
