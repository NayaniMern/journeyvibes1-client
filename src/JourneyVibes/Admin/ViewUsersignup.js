...
const ViewUserSignup = () => {
  ...
  useEffect(() => {
    axios
      .get("https://journeyvibes1-server.onrender.com/usersignup")
      .then((res) => {
  ...
  const deleteUser = (userId) => {
    axios
      .delete(`https://journeyvibes1-server.onrender.com/usersignup/${userId}`)
      .then(() => {
        alert("User deleted");
  ...
  const getOneUser = (userId) => {
    axios
      .get(`https://journeyvibes1-server.onrender.com/usersignup/${userId}`)
      .then((res) => {
  ...
  const updateUser = (e) => {
    e.preventDefault();
    axios
      .put(`https://journeyvibes1-server.onrender.com/usersignup/${_id}`, {
        username,
        email,
        password,
        confirmPassword,
